...
function Dashboard() {
  ...
  // Array of dashboard items for easy mapping
  const dashboardItems = [
    { title: 'Movie Watch List', icon: <MovieIcon /> },
    { title: 'Date Ideas', icon: <DateIcon /> },
    { title: 'Period Tracker', icon: <PeriodIcon /> },
    { title: 'Reminders', icon: <BellIcon /> },
    { title: 'Calorie Tracker', icon: <CalorieIcon /> },
    { title: 'Current Goals', icon: <GoalIcon /> },
  ];
